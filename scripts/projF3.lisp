...
(setf *t1* (loadtrack "outputs/track0.txt"))

(format t "~&Exercise 3.1 - Heuristic~&")
(with-open-file (str "outputs/out3.1.txt"
		 :direction :input)
...
(format t "~&Exercise 3.2 - A*~&")
 (let ((real1 (get-internal-real-time)))
		 (with-open-file (str "outputs/out3.2.txt" :direction :input)
...
(setf *t2* (loadtrack "outputs/track9.txt"))

(format t "~&Exercise 3.1b - Heuristic~&")
(with-open-file (str "outputs/out3.1b.txt"
		 :direction :input)
...
(format t "~&Exercise 3.2b - A*~&")
 (let ((real1 (get-internal-real-time)))
		 (with-open-file (str "outputs/out3.2b.txt" :direction :input)
